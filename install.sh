...
# --- Argo 隧道配置 ---
export ARGO_DOMAIN="idxaas.xlm.xx.kg"           # Argo 域名，留空即启用临时隧道
export ARGO_AUTH="eyJhIjoiNzU4ZTRhMjEyNDE1NjM0NThiYWY3YmYxZDBmMDI0NWQiLCJ0IjoiM2NmYjAwNGYtNDQxNy00NTRiLWFiMDMtMWZlMDFkYTJmOWFjIiwicyI6IlptSTJNVGMxWWpBdE4yUmtZaTAwWkRKakxUaGtNelF0TnpkaU5tWmlNak5tT0dZMiJ9"             # Argo Token 或 json，留空即启用临时隧道
